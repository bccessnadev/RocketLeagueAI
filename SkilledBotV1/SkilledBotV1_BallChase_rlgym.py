...
from rewards import InAirReward
...
if __name__ == '__main__':  # Required for multiprocessing
        ...
        # My Parameters
        model_folder = "models/BallChase/"
        model_name = "BallChase"
        ...
        def get_match():
                return Match(
                        ...
                        state_setter=RandomState(True, True, False),  # Resets to random location with random ball speed, car speed, and sometimes in the air
                        action_parser=DiscreteAction()  # Discrete > Continuous (less training time). A button is either pressed or it isn't
                )

        # Create enviroment/s using get_match function above
